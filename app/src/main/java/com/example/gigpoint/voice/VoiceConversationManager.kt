...
class VoiceConversationManager(
    ...
    fun handleTranscript(
        ...
        if (
            ...
            return VoiceTurn
                .Answer(
                    "Cancelled. No inventory changes were made."
                )
        }

        /**
         * Negative commands are intentionally rejected instead of trying
         * to guess the intended positive operation.
         *
         * Example:
         * "Don't remove five rice bags"
         *
         * A false interpretation here could corrupt stock, so the safe
         * behaviour is to do nothing and ask for a fresh command.
         */
        if (
            understanding
                .hasNegation(
            ...
            return VoiceTurn
                .Error(
                    message =
                        "I heard a negative or stop instruction, so I did not change inventory. Please say the command again if you want another action.",
                ...
                MissingSlot.PRODUCT -> {
                    ...
                    if (
                        ...
                        return remember(
                            ask.copy(
                                question =
                                    "I still could not identify the product. Please say only the product name again."
                            )
                        )
                    }
                ...
                MissingSlot.QUANTITY -> {
                    ...
                    if (
                        ...
                        return remember(
                            ask.copy(
                                question =
                                    "I still need the quantity. For example, say five bags, rendu kilos, or do packets."
                            )
                        )
                    }
